...
from qfast.native.uq import synthesize
...
class TestUQSynthesize ( tf.test.TestCase ):
    ...
    def test_uq_synthesize_invalid_type ( self ):
    ...
    def test_uq_synthesize_invalid_value ( self ):
